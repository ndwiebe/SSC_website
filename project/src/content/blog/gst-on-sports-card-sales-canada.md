---
title: "Do I Need to Charge GST on Sports Card Sales in Canada?"
description: "A Canadian CPA and card collector breaks down exactly when you need to charge GST on sports card sales. The $30,000 threshold, hobby vs. business rules, and how to keep records that keep you out of trouble."
pubDate: 2026-03-28
...
[Slab Savvy Tracker](/waitlist) is an inventory and record-keeping system built for card flippers and dealers. You send a photo of a card. Confirm the details. It logs acquisition cost, description, and all the fields you need for a clean tax record. When you sell, you log the proceeds and it calculates your gain.
...
SST is currently in development. [Join the waitlist](/waitlist) and I'll let you know when it's ready.
